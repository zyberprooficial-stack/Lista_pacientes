...
async function handleRegister(e) {
    ...
    // La cédula es opcional: si no hay número, enviamos cadena vacía
    let cedulaCompleta = '';
    if (regCedulaNumero && regCedulaNumero.value.trim()) {
        cedulaCompleta = `${regCedulaTipo.value}${regCedulaNumero.value.trim()}`;
    }
